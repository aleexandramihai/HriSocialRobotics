...
#code taken from the alpha_mini_rug repository, modified in order to access the length of audio time
#https://github.com/VladIftime/alpha_mini_rug/blob/c6cef2f3b7bef94dcb17aa73d88fb95df7425791/alpha-mini-rug/alpha_mini_rug/speech_to_text.py
...
class SpeechToText:
    ...
    def proses_audio(self, input_audio):
        ...
        if not self.mode_continues:
            ...
            self.audio_time = len(normalized_audio)/self.sample_rate
